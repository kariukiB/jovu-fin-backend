...
const service = {
  ...
  transactionDetails: () => FIND_MANY_RESULT,
  transactionDetail: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("TransactionDetail", () => {
  ...
  test("POST /transactionDetails", async () => {
  ...
  test("GET /transactionDetails", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /transactionDetails/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/transactionDetails"}/${nonExistingId}`)
  ...
  test("GET /transactionDetails/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/transactionDetails"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /transactionDetails existing resource", async () => {
